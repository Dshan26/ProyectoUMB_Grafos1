...
import static principal.Dijkstra.dijkstra;
...
public class Main {
    public static void main(String[] args) {
        ...
        grafo.agregarNodo("Supercade Américas");//ya
        grafo.agregarNodo("Supercade Bosa");//ya
        grafo.agregarNodo("Supercade Calle 13");//ya
        grafo.agregarNodo("Supercade Suba");//ya
        grafo.agregarNodo("Supercade Engativá");//ya
        grafo.agregarNodo("Supercade Social");//ya
        grafo.agregarNodo("Supercade Manitas");//ya
        grafo.agregarNodo("Supercade CAD");//ya
        grafo.agregarNodo("Rapicade Siete de Agosto");//ya
        grafo.agregarNodo("RAPICADE CHAPINERO CALLE 53");//ya
        ...
        try {
            ...
            grafo.agregarArista("Universidad Manuela Beltrán Sede Bogotá", "Supercade Engativá", distancia4);
            ...
            // Calcular la distancia mínima utilizando el algoritmo de Dijkstra
            String origen = "Universidad Manuela Beltrán Sede Bogotá";
            String destino = "Supercade Américas";
            List<String> rutaMinima = dijkstra(grafo, origen, destino);
